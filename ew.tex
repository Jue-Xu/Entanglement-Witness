...
\begin{problem}[entanglement detection with prior]\label{prm:entanglement_detection}
...
but more careful analysis is required for non-stabilizer cases (e.g., W state) \cite{zhangEfficientEntanglementGeneration2021} \cite{zhuMachineLearningDerivedEntanglement2021}.
