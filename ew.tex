...
\begin{itemize}
	...
	\item \nameref{def:classical_shadow} \cite{huangPredictingManyProperties2020}: estimate entanglment witness (know target state, tripartite GHZ)
...
\subsubsection{Entanglement witness via quantum trace estimation}
\begin{algorithm}[H]
    \DontPrintSemicolon
    \SetKwInOut{Input}{input}
    \SetKwInOut{Output}{output}
...
\begin{algorithm}[H]
    ...
    \caption{ansatz + classical shadow + classical SVM}
    % \label{alg:entanglement_witness}
\end{algorithm}
