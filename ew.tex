...
\end{notation}
\begin{notation}
	Denote $\pob_{\sigma}:=\bigotimes \sigma$ for a Pauli observable where $\sigma\in \qty{I,X,Y,Z}^n$ is a string of Pauli operators.
...
\end{equation}
where $\mathcal{M}$ is the channel ....
